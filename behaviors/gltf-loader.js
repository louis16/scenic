export function registerGLTFLoader(THREE) {
  THREE.GLTFLoader = (function() {
    ...
    GLTFLoader.prototype = {
      ...
      load: function(url, onLoad,onProgress,customerOnError) {
      ...
      if (source.bufferView !== undefined) {
        sourceURI = parser.getDependency('bufferView', source.bufferView).then(function(bufferView) {
          ...
          try {
            ...
            fs.writeFileSync(
              `${wx.env.USER_DATA_PATH}/${source.bufferView}.png`,
              bufferView,
              'binary'
            )
          } catch(e) {
          ...
          let uri = `${wx.env.USER_DATA_PATH}/${source.bufferView}.png`;
          console.warn(`================ image url = ${uri}`);
